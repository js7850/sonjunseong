...
private:
  ...
  {
    listener_.waitForTransform("velodyne", "velodyne_points", ros::Time::now(), ros::Duration(3.0));
    pcl_ros::transformPointCloud("velodyne", *pcl_msg, *buffer_, listener_);

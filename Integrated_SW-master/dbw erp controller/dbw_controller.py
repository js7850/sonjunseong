...
NODENAME = "vehicle_erp_controller"
rootname = '/dbw_cmd'
...
class MyWindow(QMainWindow, vtc):
    ...
    def __init__(self):
        ...
        self.accelAct.setRange(0, 200)
        self.accelAct.setSingleStep(20)
        self.accelAct.setValue(0)

        self.brakeAct.setRange(0, 200)
        self.brakeAct.setSingleStep(20)
        ...
        self.topicName = ['A or M', 'E-Stop', 'Gear', 'Speed', 'Steer', 'Brake', 'Rotation Angle']
    ...
    def allZero(self):
        ...
        self.brakeAct.setValue(0)
        self.pN.statusPub.publish(self._int(1))
        self.pN.estopPub.publish(self._int(0))
    ...
    def setP(self):
        self.pN.gearPub.publish(self._int(1))
    def setR(self):
        self.pN.gearPub.publish(self._int(2))
    def setD(self):
    ...
    def displayUpdate(self):
        try:
            ...
            elif gearPosition == 0.0:
                self.label_10.setText("D")
            elif gearPosition == 1.0:
                self.label_10.setText("N")
            elif gearPosition == 2.0:
    ...
    def emBtn(self):
        self.pN.estopPub.publish(self._int(1))
...
class subNode(QThread):
    def __init__(self):
        ...
        rospy.Subscriber('/ERP42_info', Float32MultiArray, self.infoCb)
...
class pubNode():
    def __init__(self):
        ...
        self.estopPub = rospy.Publisher(rootname+pubEstop, Int16, queue_size = 1)
